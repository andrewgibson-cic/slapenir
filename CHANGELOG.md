## [1.7.0](https://github.com/andrewgibson-cic/slapenir/compare/v1.6.0...v1.7.0) (2026-03-22)
...
* add code-graph-rag integration ([e8227fb](https://github.com/andrewgibson-cic/slapenir/commit/e8227fbba3f9c8b77fab2a4586023c0aec3d5667))
* add comprehensive terminal size diagnostics and wrapper scripts ([a1666aa](https://github.com/andrewgibson-cic/slapenir/commit/a1666aaf89d0398ae5d5e564400b5726eecc9bd4))
* add comprehensive terminal size diagnostics and wrapper scripts ([e29d2c0](https://github.com/andrewgibson-cic/slapenir/commit/e29d2c082acbd08c7abdbea175c3f60fdd234f0b))
...
* complete code-graph-rag integration ([091fa69](https://github.com/andrewgibson-cic/slapenir/commit/091fa69475fc43cf6848babcbd7576a3d7b04680))
...
* merge dev branch with Code-Graph-RAG integration ([f71fff4](https://github.com/andrewgibson-cic/slapenir/commit/f71fff46a39031b92e32001bc1b6476d2963e4ec))
...
* merge conflict in agent/Dockerfile with combined changes ([2da59d9](https://github.com/andrewgibson-cic/slapenir/commit/2da59d90f25357d0a57f2ea3d2eb349c067ed072))
...
* resolve merge conflict in .gitignore ([75de470](https://github.com/andrewgibson-cic/slapenir/commit/75de470b4a05f52eb029002ea83af284637b8246))
* resolve merge conflict in agent/Dockerfile ([6323553](https://github.com/andrewgibson-cic/slapenir/commit/632355339ddca850c5de5652a4b7afe2f5469092))
...
## [1.8.0](https://github.com/andrewgibson-cic/slapenir/compare/v1.7.0...v1.8.0) (2026-03-22)

### Features

* add MCP memory and knowledge tools to slapenir agent
* complete MCP memory and knowledge integration
* configure MCP knowledge server for air-gapped operation
* add code-graph-rag integration
* complete code-graph-rag integration
* add build tool security validation to startup checks
* implement build tool wrappers with OpenCode detection
* integrate build tool wrappers into Dockerfile
* add session lock file to opencode-wrapper
* implement session-based logging with rotation
* add comprehensive terminal size diagnostics and wrapper scripts
* Add host git/SSH/GPG config for agent container

### Security

* Add build tool execution control to prevent OpenCode abuse
  - Block gradle, mvn, npm, yarn, pnpm, cargo, pip, pip3 during OpenCode sessions
  - Multi-layer detection: lock file, environment variables, process tree
  - Emergency override mechanism (logged, discouraged)
  - Security validation in startup checks

### Bug Fixes

* configure MCP knowledge server env vars for correct paths
* add HF_HUB_OFFLINE=1 for air-gapped operation
* use all-MiniLM-L6-v2 model (no auth required)
* remove duplicate label in docker-compose.yml mcp-knowledge-data volume
* mount opencode.json as volume and remove orphan containers on down
* nest bash commands under bash key in opencode.json permissions
* patch code-graph-rag tool descriptions
* update MCP config format for code-graph-rag and refactor build wrappers
* resolve Dockerfile build issues and update opencode.json permissions
* add TTY allocation for opencode terminal size detection
* add opencode session logging to /var/log/slapenir
* Agent container user and permissions improvements
* consolidate shell access and fix terminal sizing
* dev.sh environment issues and false positive security tests
* disable traffic enforcement in make shell and add terminal size env vars
* Enable bash access for OpenCode agent with permission prompt
* improve singleton pattern and add workspace permission fix
* terminal size and git safe directory issues in dev.sh
* Use AGENTS.md for OpenCode instructions (correct mechanism)
* Add loop-prevention instructions for OpenCode agent

### Code Refactoring

* remove Ollama/Aider and improve git configuration

### Documentation

* update all READMEs with MCP tools and Code-Graph-RAG
* add build tool restrictions to AGENTS.md for OpenCode
* add logging configuration documentation
* Streamline README and remove redundant documentation

## [1.7.0](https://github.com/andrewgibson-cic/slapenir/compare/v1.6.0...v1.7.0) (2026-03-04)
